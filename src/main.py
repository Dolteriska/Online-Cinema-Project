...
app.include_router(user_profile_router,
                   prefix=f"{api_version_prefix}/profile",
                   tags=["Profiles"])
...
app.include_router(commentary_router,
                   prefix=f"{api_version_prefix}/theater",
                   tags=["Commentary"])
app.include_router(movie_and_user_interaction_router,
                   prefix=f"{api_version_prefix}/theater",
                   tags=["User interaction with movies"])
app.include_router(shopping_cart_router,
                   prefix=f"{api_version_prefix}/theater/cart",
                   tags=["Cart"])
...
app.include_router(user_admin_router,
                   prefix=f"{api_version_prefix}/admin/accounts",
                   tags=["Accounts admin"])
app.include_router(user_profile_admin_router,
                   prefix=f"{api_version_prefix}/admin/profile",
                   tags=["Profiles admin"])
app.include_router(movies_admin_router,
                   prefix=f"{api_version_prefix}/admin/theater",
                   tags=["Movies admin"])
app.include_router(order_admin_router,
                   prefix=f"{api_version_prefix}/admin/orders",
                   tags=["Order admin"])
app.include_router(shopping_cart_admin_router,
                   prefix=f"{api_version_prefix}/admin/theater/cart",
                   tags=["Cart admin"])
app.include_router(payment_admin_router,
                   prefix=f"{api_version_prefix}/admin/payments",
                   tags=["Payment admin"])
