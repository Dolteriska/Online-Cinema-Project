...
class JWTAuthManager(JWTAuthManagerInterface):
    """
    A manager for creating,
     decoding, and verifying JWT access and refresh tokens.
    """

    _ACCESS_KEY_TIMEDELTA_MINUTES\
        = settings.ACCESS_TOKEN_EXPIRE_MINUTES
    _REFRESH_KEY_TIMEDELTA_MINUTES\
    ...
    def __init__(self,
        ...
        Initialize the manager
         with secret keys and algorithm for token operations.
        """
