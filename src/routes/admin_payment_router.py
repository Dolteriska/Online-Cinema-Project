...
from src.schemas.admin_payment_schema import (AdminPaymentResponseSchema,
...
async def get_all_payments(
    ...
    base_stmt = select(Payment).options(
    ...
    return AdminPaymentListResponseSchema(
        items=[AdminPaymentResponseSchema.model_validate(payment)
